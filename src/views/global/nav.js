...
<nav class="border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-8">
    <a href="/" class="">
      <img src="https://imgs.search.brave.com/KL2cctloDLPOXnlilm-pVKWX3QYXZVouX7d1-hmY54k/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/bG9nb2dlbmllLmZy/L2ljb25zL3ByZXZp/ZXcvMTEzOTg" class="h-14" alt="Colocation Logo" />
    </a>
