  ...
  <form class="bg-white" method='POST' id='form-register'>
    ...
    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
      ...
      <div class=" border-2 my-4 py-2 px-3 rounded-2xl">
        <textarea id="message" rows="4" class="resize-none block p-2.5 w-full text-md text-gray-900 rounded-lg border-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Votre message"></textarea>
      </div>
