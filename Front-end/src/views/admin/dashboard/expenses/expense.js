...
<div class="relative min-w-56 flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
  <div class='p-3'>
    ...
    <p class="absolute right-0 top-3 antialiased inline font-sans text-right bg-customBlue-200 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-customGreen-300">${date}</p>
  </div>
  ...
  <div class="border-t border-blue-gray-50 p-4">
    ...
    <form action="" class='change-status-expense'>
      <input type='hidden' value='${expense_id}' name='expense' class='input-expense bg-button-btn-bg'>
      <span id="badge-dismiss-green" class="inline-flex items-center px-2 py-1 me-2 text-sm font-medium text-customBlue-500 blue-200 rounded bg-customBlue-200">
          Marqué comme Payé
